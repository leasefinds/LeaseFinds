...
import styles from "./TextImageLeft.module.scss"

export const fragment = graphql`
  fragment TextImageLeft on WPGraphQL_Page_Sectionfields_Sections_TextImageLeft {
    content
    button {
      text
      url
...
const TextImageLeft = ({ content, image, button }) => {
